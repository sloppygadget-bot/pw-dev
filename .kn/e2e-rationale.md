...
The suite asserts user-visible contracts: discovery, app/template/session
state, returned CDP URLs, lease exclusivity/reuse, and persistence semantics.
...
- Sources: `AGENTS.md`, `packages/server/instructions/agent.md`, `packages/server/test/server.test.js`
